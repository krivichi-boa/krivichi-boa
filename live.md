...
*Когда трансляция активна, вы можете смотреть её прямо здесь. Если эфира нет, ниже доступна запись нашей крайней встречи.*

<!-- Встроенное видео с YouTube (код заглушки, его можно менять на любой стрим) -->
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.15);">
...
<div style="background-color: #f9f9f9; padding: 20px; border-radius: 6px; border-left: 5px solid #00bcd4; margin-bottom: 20px;">
  <h4 style="margin-top: 0; color: #00bcd4;">🌱 Живая встреча: Обмен растениями и опыт запуска на сойлах</h4>
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-calendar-alt"></i> <b>Дата:</b> Уточняется (Октябрь 2026)</p>
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-map-marker-alt"></i> <b>Место:</b> г.п. Кривичи / Онлайн-трансляция в блоге</p>
  <p style="margin: 10px 0 0 0; font-size: 15px;">Планируем собраться кругом единомышленников, обсудить проблемы «старой воды» и поделиться излишками аквариумного мха, валлиснерии и анубиасов. Присоединяйтесь!</p>
</div>

<div style="background-color: #f9f9f9; padding: 20px; border-radius: 6px; border-left: 5px solid #4caf50;">
  <h4 style="margin-top: 0; color: #4caf50;">💻 Онлайн-вебинар: Азотный цикл «от А до Я»</h4>
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-calendar-alt"></i> <b>Тип:</b> Прямой эфир на YouTube</p>
  <p style="margin: 10px 0 0 0; font-size: 15px;">Разберем на схемах и графиках химические процессы в фильтре. Ответы на вопросы новичков в прямом эфире через наш онлайн-чат поддержки.</p>
</div>

---

### 🔔 Как не пропустить эфир?
Анонсы всех включений мы дублируем в наш **Telegram-канал** и **Instagram**. Если у вас есть предложение по теме следующей трансляции — напишите нам прямо сейчас в окно чата в правом углу!
