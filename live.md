...
<iframe width="560" height="315" src="https://youtube.com/embed/live_stream?channel=UCZs9x8Z2C3NwX-LoCgEIrCQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<div style="background-color: #f9f9f9; padding: 20px; border-radius: 6px; border-left: 5px solid #00bcd4; margin-bottom: 20px;">
  <h4 style="margin-top: 0; color: #d4d000;">🌱 Какие аквариумы бываю? .</h4>
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-calendar-alt"></i> <b>Дата:</b> 4 сентября 2026 г. в 20:30.</p>
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-map-marker-alt"></i> <b>Место:</b>Онлайн-встреча в ТГ.</p>
  <p style="margin: 10px 0 0 0; font-size: 15px;">Разберём виды аквариумы.</p>
</div>
...
<div style="background-color: #f9f9f9; padding: 20px; border-radius: 6px; border-left: 5px solid #4caf50;">
  ...
  <p style="margin: 5px 0; font-size: 14px; color: #666;"><i class="fas fa-calendar-alt"></i> <b>Тип:</b> Прямой эфир на Telegram-канале.</p>
